...
# ╔═╡ b7252fef-228e-4eb9-a163-0ced9f877cf0
begin
	using PlutoUI
	using GLMakie
...
# ╔═╡ 0ec9b8fe-f2a9-11ee-21ad-ab671e647352
@bind parameters1 PlutoUI.combine() do child
	md"""
	## Parameters 1
	- Item 1: $(child(PlutoUI.Slider(1:5; show_value=true)))
	- Item 2: $(child(PlutoUI.TextField(default = "5")))
	"""
end

# ╔═╡ 59564c51-6694-4c00-b532-9921b656e69b
@bind parameters2 PlutoUI.combine() do child
	md"""
	## Parameters 2
	- Item 3: $(child(PlutoUI.Slider(1:5; show_value=true)))
	- Item 4: $(child(PlutoUI.TextField(default = "3")))
	"""
end

# ╔═╡ 8439d9e9-c4b2-49b0-a3aa-a609de24397c
md"""
## Plot
"""

# ╔═╡ 96b94d41-52b6-4e49-991e-544f90bac115
begin
	parameters1;
	parameters2;
	
	md"""
	### Click to plot: $(@bind trigger CheckBox(default=false))
	"""
end

# ╔═╡ f63002e7-c8be-4ba5-a4b3-49767baa7e04
md"""
## Long Calculation
"""

# ╔═╡ 181dc26c-1885-4986-81a0-7b2489aedd51
if trigger
	result = [parameters1[1], parse(Int64, parameters1[2]), parameters2[1],parse(Int64, parameters2[2])]
else
	result = nothing
end

# ╔═╡ 02a14860-adf6-43cc-9974-0fac089f4db5
if result !== nothing
	lines(result)
end

# ╔═╡ 04d961b3-2ef3-467a-bb19-6c79f57389c6
md"""
## Windows
"""

# ╔═╡ 0764c041-f7f4-471f-8151-4d69ab6c015f
...
# ╔═╡ 2e266c8e-3dcc-4e6f-8b42-3607613eaed2
begin
param_interface = @bind parameters PlutoUI.confirm(PlutoUI.combine() do child
	md"""
	# Parameters
...
@htl """<div style="position: fixed; left: 1rem; top: 15rem; 
	padding: 5px;
	text-align: center;
	border-color: antiquewhite; border-width: 2px; border-style: solid;
	background-color: var(--main-bg-color);">
...
manifest_format = "2.0"
project_hash = "4daa82d28cd1d55fc879805245197f539fe4ba7d"
